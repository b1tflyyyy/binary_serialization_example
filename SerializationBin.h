...
namespace szon
{
	...
	public:
		...
		virtual ~SerializationBin() = default;

		SerializationBin(const SerializationBin& other) = delete;
...
#pragma region Implementation
	...
	SerializationBin::SerializationBin()
	{
	...
	template<typename T>
	void SerializationBin::SerializeArrayOfData(T* data, const int size, std::string_view path)
	{
	...
	template<typename T>
	void SerializationBin::DeserializeArrayOfData(T* data, const int size, std::string_view path)
	{
	...
	template<>
	void SerializationBin::SerializeArrayOfData<std::string>(std::string* data, const int size, std::string_view path)
	{
		m_fout.open(path.data(), std::ios::binary | std::ios::app | std::ios::out);
	...
	template<>
	void SerializationBin::DeserializeArrayOfData<std::string>(std::string* data, const int size, std::string_view path)
	{
		m_fin.open(path.data(), std::ios::binary | std::ios::in);
		m_fin.seekg(m_current_position, std::ios_base::beg);
	...
	template<typename T>
	void SerializationBin::SerializeData(const T& data, std::string_view path)
	{
		m_fout.open(path.data(), std::ios::binary | std::ios::app | std::ios::out);
	...
	template<typename T>
	void SerializationBin::DeserializeData(T& data, std::string_view path)
	{
		m_fin.open(path.data(), std::ios::binary | std::ios::in);
		m_fin.seekg(m_current_position, std::ios_base::beg);
	...
	template<>
	void SerializationBin::SerializeData<std::string>(const std::string& data, std::string_view path)
	{
		m_fout.open(path.data(), std::ios::binary | std::ios::app | std::ios::out);
	...
	template<>
	void SerializationBin::DeserializeData<std::string>(std::string& data, std::string_view path)
	{
		m_fin.open(path.data(), std::ios::binary | std::ios::in);
		m_fin.seekg(m_current_position, std::ios_base::beg);
	...
	bool SerializationBin::IsFileEmpty(std::string_view path)
	{
		m_fin.open(path.data(), std::ios::binary | std::ios::in);
	...
	void SerializationBin::ResetFileReadPosition() { m_current_position = NULL; }

	void SerializationBin::ClearFile(std::string_view path)
	{
		m_current_position = NULL;
